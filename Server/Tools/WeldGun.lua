...
function WeldGun:OnWeld(player, targeting_first_to, targeting_second_to, targeting_second_location)
	...
	local constraint_offset = targeting_first_to:GetRotation():UnrotateVector(welding_start_world_location - welding_end_world_location) / targeting_first_to:GetScale()
