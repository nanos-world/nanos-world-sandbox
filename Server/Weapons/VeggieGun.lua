...
function SpawnVeggieGun(location, rotation)
	...
	weapon:SetMaterialTextureParameter("Texture", "assets///nanos-world/Textures/Pattern/T_Watermelon_Pattern.jpg")
	...
	weapon:Subscribe("Fire", function(self, character)
		...
		local prop = Prop(spawn_location, Rotator.Random(), veggie_mesh, CollisionType.Normal, true, false)
		prop:SetLifeSpan(5)
