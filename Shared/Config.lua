...
CHARACTER_MESHES = {
	SK_Male = "nanos-world::SK_Male",
	SK_Female = "nanos-world::SK_Female",
	SK_Mannequin = "nanos-world::SK_Mannequin",
	SK_Mannequin_Female = "nanos-world::SK_Mannequin_Female",
	SK_ClassicMale = "nanos-world::SK_ClassicMale",
	SK_PostApocalyptic = "nanos-world::SK_PostApocalyptic",
}
