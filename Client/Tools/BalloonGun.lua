...
function BalloonGun:OnLocalPlayerPickUp(character)
	...
	ContextMenu.AddItems("balloon_tool", "balloon gun", {
		{ id = "baloon_asset", type = "select_image", label = "Asset", callback_event = "SelectBalloonAsset", selected = BalloonGun.asset, options = {
			{ id = "nanos-world::SM_Balloon_01", name = "SM_Balloon_01", image = "assets://NanosWorld/Thumbnails/SM_Balloon_01.jpg" },
			{ id = "nanos-world::SM_Balloon_02", name = "SM_Balloon_02", image = "assets://NanosWorld/Thumbnails/SM_Balloon_02.jpg" },
			{ id = "nanos-world::SM_Balloon_03", name = "SM_Balloon_03", image = "assets://NanosWorld/Thumbnails/SM_Balloon_03.jpg" },
			{ id = "nanos-world::SM_Balloon_04", name = "SM_Balloon_04", image = "assets://NanosWorld/Thumbnails/SM_Balloon_04.jpg" },
			{ id = "nanos-world::SM_Balloon_05", name = "SM_Balloon_05", image = "assets://NanosWorld/Thumbnails/SM_Balloon_05.jpg" },
			{ id = "nanos-world::SM_Balloon_06", name = "SM_Balloon_06", image = "assets://NanosWorld/Thumbnails/SM_Balloon_06.jpg" },
			{ id = "nanos-world::SM_Balloon_07", name = "SM_Balloon_07", image = "assets://NanosWorld/Thumbnails/SM_Balloon_07.jpg" },
			{ id = "nanos-world::SM_Balloon_Trump", name = "SM_Balloon_Trump", image = "assets://NanosWorld/Thumbnails/SM_Balloon_Trump.jpg" },
			{ id = "nanos-world::SM_Balloon_Dog", name = "SM_Balloon_Dog", image = "assets://NanosWorld/Thumbnails/SM_Balloon_Dog.jpg" },
			{ id = "nanos-world::SM_Poop", name = "SM_Poop", image = "assets://NanosWorld/Thumbnails/SM_Poop.jpg" },
			{ id = "nanos-world::SM_Emoji_01", name = "SM_Emoji_01", image = "assets://NanosWorld/Thumbnails/SM_Emoji_01.jpg" },
			{ id = "nanos-world::SM_Emoji_02", name = "SM_Emoji_02", image = "assets://NanosWorld/Thumbnails/SM_Emoji_02.jpg" },
			{ id = "nanos-world::SM_Emoji_03", name = "SM_Emoji_03", image = "assets://NanosWorld/Thumbnails/SM_Emoji_03.jpg" },
			{ id = "nanos-world::SM_Emoji_04", name = "SM_Emoji_04", image = "assets://NanosWorld/Thumbnails/SM_Emoji_04.jpg" },
		}},
