...
NPC_PostApocalyptic.name = "Post Apocalyptic"
NPC_PostApocalyptic.image = "assets://NanosWorld/Thumbnails/SK_PostApocalyptic.jpg"

NPC_ClassicMale = NPC.Inherit("NPC_ClassicMale")
NPC_ClassicMale.name = "Classic Male"
NPC_ClassicMale.image = "assets://NanosWorld/Thumbnails/SK_ClassicMale.jpg"

NPC_Male = NPC.Inherit("NPC_Male")
NPC_Male.name = "Male"
NPC_Male.image = "assets://NanosWorld/Thumbnails/SK_Male.jpg"

NPC_Female = NPC.Inherit("NPC_Female")
NPC_Female.name = "Female"
NPC_Female.image = "assets://NanosWorld/Thumbnails/SK_Female.jpg"